...
def transition_list(a, s, m, n, p, stay):
...
def gridworld_middle(m, n, stay, horizon,
                     p, r,
    ...
    available_locations = [(0, 0), (1, 0), (2, 0), (1, 1)]
    ...
    if not switch:  # when goal reached, stay in goal
        for al, x1t, x2t in states:
            ...
            for action in actions:
                ...
                ag1_p = transition_list(ag1_a, ag1_s, m, n, p, locations)
                ag2_p = transition_list(ag2_a, ag2_s, m, n, p, locations)
