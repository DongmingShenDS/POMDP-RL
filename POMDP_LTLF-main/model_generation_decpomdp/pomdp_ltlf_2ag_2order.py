...
import copy
from gridworld_reward_order import gridworld_order
...
def generate(m, n, horizon, p, r, n_agent, agent_pri, orders_pri, start, private, rew, rewards, switch, p_stay,
    ...
    pomdp = gridworld_order(m, n, stay, horizon,
                            p, r,
    ...
    for s_i, s in enumerate(pomdp.states[1]):
        ...
        if al[0] in collide and al[1] in collide and near(al[0], al[1]):
            label_v[s_i] += ('c',)
        # if ag1 pri = A, then go to (0, 14) then (4, 14) strict order == a->b
        if x1t == "A":
            if al[0] == (0, 14):
                label_v[s_i] += ('a',)
            elif al[0] == (4, 14):
                label_v[s_i] += ('b',)
        # if ag1 pri = B, then go to (4, 14) then (0, 14) strict order == a->b
        if x1t == "B":
            if al[0] == (0, 14):
                label_v[s_i] += ('b',)
            elif al[0] == (4, 14):
...
def expo_gradient(pomdp_model, pomdpsol_path, output_path, display_path, discount, timeout, memory, precision, val_b,
    ...
    :param timer: [time0=Total Solving & Loading Time; time1=Total Simulation Time]
    ...
    for k in range(total_k):
        ...
        if k == 0:
            policy = sarsop(pomdp_k.agent,
                            ...
                            remove_generated_files=False,   # always false
            ...
            policy = sarsop(pomdp_k.agent,
                            ...
                            pomdp_name="/Users/shendongming/Desktop/AIDyS/AIDyS_pomdp/pomdp_ltlf/model_generation_decpomdp/temp-pomdp",
                            remove_generated_files=False,   # always false
                            modify_reward_only=True)    # always true
        toc = tictoc.perf_counter()
        timer[0] += toc - tic
...
def main():
    ...
    output_path = "/Users/shendongming/Desktop/AIDyS/AIDyS_pomdp/pomdp_ltlf/model_generation_decpomdp/results_mid/order/ma_grid14x14_2order2.txt"
    display_path = "/Users/shendongming/Desktop/AIDyS/AIDyS_pomdp/pomdp_ltlf/model_generation_decpomdp/results_mid/order/ma_grid14x14_2order2.png"
    ...
    "create pomdp model"
    constrained_pomdp = generate(m=15, n=15, horizon=2, p=1, r=1, n_agent=2,
                                 agent_pri=[[(0, 14), (4, 14)], [(2, 11)]],
                                 orders_pri=[["A", "B"], ["X"]],
                                 start=[(2, 0), (0, 6)],
                                 private="NOTgoal",
                                 rew="goal", rewards=None,
                                 switch=False, p_stay=1.0,
                                 collide=[(2, 0), (2, 1), (2, 2), (2, 3), (2, 4), (2, 5), (2, 6), (2, 7), (2, 8),
                                          (2, 9), (2, 10), (2, 11), (2, 12), (0, 6), (1, 6), (0, 12), (1, 12), (3, 9),
                                          (4, 9), (4, 10), (4, 11), (4, 12), (4, 13), (4, 14), (0, 13), (0, 14),
                                          (1, 14), (2, 14), (3, 14)],
                                 stay=[(2, 0), (2, 1), (2, 2), (2, 3), (2, 4), (2, 5), (2, 6), (2, 7), (2, 8), (2, 9),
                                       (2, 10), (2, 11), (2, 12), (0, 6), (1, 6), (0, 12), (1, 12), (3, 9), (4, 9),
                                       (4, 10), (4, 11), (4, 12), (4, 13), (4, 14), (0, 13), (0, 14), (1, 14), (2, 14),
                                       (3, 14)],
                                 specifications="G(!c) & (!b U (a & F(b)))",
                                 thres=0.5)
