    ...
    for k in range(total_k):
        ...
        if k == 0:
            policy = sarsop(pomdp_k.agent,
                            ...
                            modify_reward_only=True)  # false if no pre-saved file exists
        else:
            policy = sarsop(pomdp_k.agent,
                            pomdpsol_path,
                            discount_factor=discount,
...
def main():
    ...
    output_path = "/Users/shendongming/Desktop/AIDyS/AIDyS_pomdp/pomdp_ltlf/model_generation_decpomdp/results_mid/ma_grid5x5/ma_grid5x5_pri2x2_swi_final.txt"
    display_path = "/Users/shendongming/Desktop/AIDyS/AIDyS_pomdp/pomdp_ltlf/model_generation_decpomdp/results_mid/ma_grid5x5/ma_grid5x5_pri2x2_swi_final.png"
