...
def generate(m, n, horizon, p, r, n_agent, agent_pri, start, private, rew, rewards, switch, p_swi,
    ...
    pomdp = gridworld(m, n, horizon, p, r, n_agent, agent_pri, start, private, rew, rewards, switch, p_swi)
    ...
    for s_i, s in enumerate(pomdp.states[1]):
        ...
        if al[0] in collide and al[1] in collide and al[0]==al[1]:
            label_v[s_i] += ('c',)
        # both agents in stay
...
def main():
    output_path = "results/ma_grid3x3_switch/ma_grid3x3_pri2x1_switch_conflict_diffR.txt"
    display_path = "results/ma_grid3x3_switch/ma_grid3x3_pri2x1_switch_conflict_diffR.png"
    ...
    constrained_pomdp = generate(m=3, n=3, horizon=2, p=1, r=1, n_agent=2,
                                 agent_pri=[[(1, 2), (0, 1)], [(1, 1)]],
                                 start=[(1, 0), (0, 1)],
                                 private="goal",
                                 rew="goal",
                                 rewards=[[1, 1], [1]],
                                 switch=False, p_swi=0,
