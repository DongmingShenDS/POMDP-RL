...
def main():
	algorithm = input("enter algorithm name: ")  # PPO / DQN
	models_dir = input("enter model path: ")  # PPO/models/1661735520
	if not os.path.exists(models_dir):
		print("model dir DNE. STOPPING.")
		exit(0)
	logdir = models_dir.replace("models", "logs")
	model_exact = input("enter exact model .zip: ")  # 1000000.zip
