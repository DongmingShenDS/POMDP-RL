...
class DFA():
    ...
    def __init__(self, formula_str, file_str):
        ...
        :param file_str: /Users/dongmingshen/PycharmProjects/AlvinLab/venv/lib/python3.9/site-packages
        """
